...
public class EntityFish extends Entity
{
    ...
    public void onUpdate()
    {
        ...
        if(!worldObj.singleplayerWorld)
        {
            ...
            if(angler.isDead || !angler.func_25021_O() || itemstack == null || itemstack.getItem() != Item.fishingRod || getDistanceSqToEntity(angler) > 1024D)
            {
                setEntityDead();
    ...
    public int func_6143_c()
    {
        ...
        if(ticksCatchable > 0)
        {
            ...
            angler.func_26604_a(StatList.field_25095_x, 1);
            byte0 = 1;
        }
        if(inGround)
        {
