...
class InventoryCraftResult
{
    ...
    InventoryCraftResult(int i, int j, Object obj, InventoryCraftResult inventorycraftresult)
    {
        field_26700_b = obj;
    ...
    public final boolean equals(Object obj)
    {
        ...
        Integer integer = Integer.valueOf(func_26699_a());
        Integer integer1 = Integer.valueOf(inventorycraftresult.func_26699_a());
    ...
    final int stackResult;
    Object field_26700_b;
    InventoryCraftResult field_26702_c;
    final int field_26701_d;
}
