...
public abstract class EntityLiving extends Entity
{
    ...
    public void spawnExplosionParticle()
    {
        ...
        if(func_25021_O() && isEntityInsideOpaqueBlock())
        {
        ...
        if(func_25021_O() && isInsideOfMaterial(Material.water) && !canBreatheUnderwater())
        {
            air--;
            if(air == -20)
            {
    ...
    public boolean func_26581_O()
    {
        return currentTarget != null;
    }

    public Entity func_26580_P()
    {
