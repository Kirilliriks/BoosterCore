...
public class Block
{
    ...
    protected void func_26519_a(boolean flag)
    {
    ...
    public boolean func_26522_a(WorldGenLiquids worldgenliquids, int i, int j, int k, int l)
    {
        ...
        {
            return !worldgenliquids.isBlockOpaqueCube(i, j, k);
        }
    }
    ...
    {
        return StatCollector.func_25136_a((new StringBuilder()).append(getBlockName()).append(".name").toString());
    }
    ...
    public static final BlockRedstoneRepeater grass;
    ...
    public static final Block bed = (new BlockBed(26)).setHardness(0.2F).setBlockName("bed");
    ...
    public static final ItemArmor plantYellow;
    public static final ItemArmor plantRed;
    public static final ItemArmor mushroomBrown;
    public static final ItemArmor mushroomRed;
    ...
    public static final ItemPainting fire;
...
//        field_537_s = new boolean[256];
        ...
        grass = (BlockRedstoneRepeater)(new BlockRedstoneRepeater(2)).setHardness(0.6F).setStepSound(soundGrassFootstep).setBlockName("grass");
        ...
        lavaMoving = (new BlockFlowing(10, Material.lava)).setHardness(0.0F).setLightValue(1.0F).setLightOpacity(255).setBlockName("lava");
        lavaStill = (new BlockStationary(11, Material.lava)).setHardness(100F).setLightValue(1.0F).setLightOpacity(255).setBlockName("lava");
        ...
        sponge = (new RecipesWeapons(19)).setHardness(0.6F).setStepSound(soundGrassFootstep).setBlockName("sponge");
        ...
        plantYellow = (ItemArmor)(new ItemArmor(37, 13)).setHardness(0.0F).setStepSound(soundGrassFootstep).setBlockName("flower");
        plantRed = (ItemArmor)(new ItemArmor(38, 12)).setHardness(0.0F).setStepSound(soundGrassFootstep).setBlockName("rose");
        mushroomBrown = (ItemArmor)(new BlockMushroom(39, 29)).setHardness(0.0F).setStepSound(soundGrassFootstep).setLightValue(0.125F).setBlockName("mushroom");
        mushroomRed = (ItemArmor)(new BlockMushroom(40, 28)).setHardness(0.0F).setStepSound(soundGrassFootstep).setBlockName("mushroom");
        ...
        stairDouble = (new Packet255KickDisconnect(43, true)).setHardness(2.0F).setResistance(10F).setStepSound(soundStoneFootstep).setBlockName("stoneSlab");
        stairSingle = (new Packet255KickDisconnect(44, false)).setHardness(2.0F).setResistance(10F).setStepSound(soundStoneFootstep).setBlockName("stoneSlab");
        ...
        torchWood = (new BlockSoil(50, 80)).setHardness(0.0F).setLightValue(0.9375F).setStepSound(soundWoodFootstep).setBlockName("torch");
        fire = (ItemPainting) new ItemPainting(51, 31).setHardness(0.0F).setLightValue(1.0F).setStepSound(soundWoodFootstep).setBlockName("fire");
        ...
        signWall = (new BlockSign(68, MobSpawnerRainforest.class, false)).setHardness(1.0F).setStepSound(soundWoodFootstep).setBlockName("sign");
        lever = (new BlockDispenser(69, 96)).setHardness(0.5F).setStepSound(soundWoodFootstep).setBlockName("lever");
        ...
        blockSnow = (new ServerWindowAdapter(80, 66)).setHardness(0.2F).setStepSound(soundClothFootstep).setBlockName("snow");
        ...
        bloodStone = (new ItemFlintAndSteel(87, 103)).setHardness(0.4F).setStepSound(soundStoneFootstep).setBlockName("hellrock");
