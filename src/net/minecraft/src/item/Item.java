...
public class Item
{
    ...
    {
        return StatCollector.func_25136_a((new StringBuilder()).append(getItemName()).append(".name").toString());
    }
    ...
    public static Item bread = (new BlockStep(41, 5, false)).setIconCoord(9, 2).setItemName("bread");
    public static Item helmetLeather = (new Packet54(42, 0, 0, 0)).setIconCoord(0, 0).setItemName("helmetCloth");
    public static Item plateLeather = (new Packet54(43, 0, 0, 1)).setIconCoord(0, 1).setItemName("chestplateCloth");
    public static Item legsLeather = (new Packet54(44, 0, 0, 2)).setIconCoord(0, 2).setItemName("leggingsCloth");
    public static Item bootsLeather = (new Packet54(45, 0, 0, 3)).setIconCoord(0, 3).setItemName("bootsCloth");
    public static Item helmetChain = (new Packet54(46, 1, 1, 0)).setIconCoord(1, 0).setItemName("helmetChain");
    public static Item plateChain = (new Packet54(47, 1, 1, 1)).setIconCoord(1, 1).setItemName("chestplateChain");
    public static Item legsChain = (new Packet54(48, 1, 1, 2)).setIconCoord(1, 2).setItemName("leggingsChain");
    public static Item bootsChain = (new Packet54(49, 1, 1, 3)).setIconCoord(1, 3).setItemName("bootsChain");
    public static Item helmetSteel = (new Packet54(50, 2, 2, 0)).setIconCoord(2, 0).setItemName("helmetIron");
    public static Item plateSteel = (new Packet54(51, 2, 2, 1)).setIconCoord(2, 1).setItemName("chestplateIron");
    public static Item legsSteel = (new Packet54(52, 2, 2, 2)).setIconCoord(2, 2).setItemName("leggingsIron");
    public static Item bootsSteel = (new Packet54(53, 2, 2, 3)).setIconCoord(2, 3).setItemName("bootsIron");
    public static Item helmetDiamond = (new Packet54(54, 3, 3, 0)).setIconCoord(3, 0).setItemName("helmetDiamond");
    public static Item plateDiamond = (new Packet54(55, 3, 3, 1)).setIconCoord(3, 1).setItemName("chestplateDiamond");
    public static Item legsDiamond = (new Packet54(56, 3, 3, 2)).setIconCoord(3, 2).setItemName("leggingsDiamond");
    public static Item bootsDiamond = (new Packet54(57, 3, 3, 3)).setIconCoord(3, 3).setItemName("bootsDiamond");
    public static Item helmetGold = (new Packet54(58, 1, 4, 0)).setIconCoord(4, 0).setItemName("helmetGold");
    public static Item plateGold = (new Packet54(59, 1, 4, 1)).setIconCoord(4, 1).setItemName("chestplateGold");
    public static Item legsGold = (new Packet54(60, 1, 4, 2)).setIconCoord(4, 2).setItemName("leggingsGold");
    public static Item bootsGold = (new Packet54(61, 1, 4, 3)).setIconCoord(4, 3).setItemName("bootsGold");
    ...
    public static Item fishRaw = (new BlockStep(93, 2, false)).setIconCoord(9, 5).setItemName("fishRaw");
    public static Item fishCooked = (new BlockStep(94, 5, false)).setIconCoord(10, 5).setItemName("fishCooked");
    ...
    static 
    {
        shovelSteel = (new BlockFlower(0, EnumToolMaterial.IRON)).setIconCoord(2, 5).setItemName("shovelIron");
        ...
        shovelWood = (new BlockFlower(13, EnumToolMaterial.WOOD)).setIconCoord(0, 5).setItemName("shovelWood");
        ...
        shovelStone = (new BlockFlower(17, EnumToolMaterial.STONE)).setIconCoord(1, 5).setItemName("shovelStone");
        ...
        shovelDiamond = (new BlockFlower(21, EnumToolMaterial.EMERALD)).setIconCoord(3, 5).setItemName("shovelDiamond");
        ...
        shovelGold = (new BlockFlower(28, EnumToolMaterial.GOLD)).setIconCoord(4, 5).setItemName("shovelGold");
