    ...
    implements IChunkLoader
{
    ...
    public static void storeChunkInCompound(Chunk chunk, World world, NBTTagCompound nbttagcompound)
    {
        ...
        nbttagcompound.setByteArray("Data", chunk.data.field_26706_a);
        nbttagcompound.setByteArray("SkyLight", chunk.skylightMap.field_26706_a);
        nbttagcompound.setByteArray("BlockLight", chunk.blocklightMap.field_26706_a);
