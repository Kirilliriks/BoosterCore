...
public class MapGenCaves extends MapGenBase
{
            ...
            double d3)
    {
        ...
        for(; k < l; k++)
        {
            ...
            int k8 = MathHelper.floor_double(d - d6) - i * 16 - 1;
            int k1 = (MathHelper.floor_double(d + d6) - i * 16) + 1;
            int k9 = MathHelper.floor_double(d1 - d7) - 1;
            int l1 = MathHelper.floor_double(d1 + d7) + 1;
            int k10 = MathHelper.floor_double(d2 - d6) - j * 16 - 1;
            ...
            boolean flag2 = false;
            for(int j2 = k8; !flag2 && j2 < k1; j2++)
            {
                for(int l2 = k10; !flag2 && l2 < i2; l2++)
                {
                    for(int i3 = l1 + 1; !flag2 && i3 >= k9 - 1; i3--)
                    {
                        ...
                        if(i3 != k9 - 1 && j2 != k8 && j2 != k1 - 1 && l2 != k10 && l2 != i2 - 1)
                        {
                            i3 = k9;
                        }
                    }
            ...
            for(int k2 = k8; k2 < k1; k2++)
            {
                double d12 = (((double)(k2 + i * 16) + 0.5D) - d) / d6;
label0:
                for(int k3 = k10; k3 < i2; k3++)
                {
